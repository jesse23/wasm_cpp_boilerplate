...
var ASM_CONSTS = [function() { squareVal = Module.cwrap('squareVal', 'number', ['number']); var x = 12.5; console.log('Computing: ' + x + ' * ' + x + ' = ' + squareVal(x)); }];
...
var _squareVal = Module["_squareVal"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_squareVal"].apply(null, arguments)
};
